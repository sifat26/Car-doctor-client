...
const About = () => {
  ...
  <div className="hero-content flex-col lg:flex-row">
    ...
    <div className='lg:w-1/2 space-y-5'>
      ...
      <p className=" py-3 text-[#737373]">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which donot look even slightly believable. 
       </p>
